...
public class MainWindow extends DisplayWindow {
	...
	@Override
	public void addNotes(final int counter, final String[] names, final int[] octaves, final double[] x,
			final double[] y, final boolean[] hidden) {
		Display.getDefault().syncExec(new Runnable() {
			@Override
			public void run() {
