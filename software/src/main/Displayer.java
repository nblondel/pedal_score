			...
			try {
				...
				while (isRunning) {
					...
					if (pitchBuffer != null) {
						...
						displayWindow.addPitches(pitchBuffer.size(), pitchBuffer.getTimeArray(),
								pitchBuffer.getFrequencyArray());
						pitchBuffer.clear();
					}
					...
					if (noteBuffer != null) {
						...
						displayWindow.addNotes(noteBuffer.size(), noteBuffer.getNamesArray(),
								noteBuffer.getOctavesArray(), noteBuffer.getTimeArray(), noteBuffer.getFrequencyArray(),
								noteBuffer.getHiddenArray());
						noteBuffer.clear();
					}
				}
			} catch (Exception e) {
